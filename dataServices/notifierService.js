...
module.exports = {
    notifyCaseMessage(ownerRegistrationId, caseData) {
        this.sendMessage([ownerRegistrationId], 'you have a message', 'a new message is waiting for you about ' + caseData.title);
    },
